                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="me-3">
                                        <span class="avatar avatar-lg"
                                            style="background-color: {{ $year->is_active ? '#2fb344' : '#6c757d' }}; color: white;">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-7">
                                            <span class="badge bg-yellow">
                                                {{ $year->semester == 1 ? 'Semester 1 (Ganjil)' : 'Semester 2 (Genap)' }}
                                            </span>
                                        </div>
                                    ...
                                    @if (!$year->is_active)
                                        <div class="col">
                                            <form action="{{ route('admin.academic-years.activate', $year) }}"
                                                ...
                                                @method('PUT')
                                                <button type="submit"
                                                    class="btn btn-sm btn-success w-100">Aktifkan</button>
                                            </form>
                                        </div>
                                    @endif
                                    <div class="col">
                ...
                @empty
                    <div class="col-12">
                        <div class="empty">
                            ...
                            <p class="empty-subtitle text-secondary">Klik tombol "Tambah Tahun Ajaran" untuk membuat tahun
                                ajaran baru</p>
                        </div>
                    </div>
                @endforelse
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3"
                                placeholder="Deskripsi tahun ajaran (opsional)"></textarea>
                        </div>
                    </div>
